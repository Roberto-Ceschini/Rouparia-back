...
INSERT INTO "new_Registro" ("colaborador_id", "data", "id", "quantidade", "status") SELECT "colaborador_id", "data", "id", coalesce("quantidade", 1) AS "quantidade", "status" FROM "Registro";
DROP TABLE "Registro";
